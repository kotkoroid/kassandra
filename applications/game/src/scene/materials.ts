...
export const GOLD_TRIM_MAT = new MeshStandardMaterial({ color: '#d4a23a', metalness: 0.4, roughness: 0.48 });
/** Steel sword/broadsword blades */
export const STEEL_BLADE_MAT = new MeshStandardMaterial({ color: '#d4d4dc', metalness: 0.7, roughness: 0.3 });
/** Arrow-tip steel */
export const ARROW_HEAD_MAT = new MeshStandardMaterial({ color: '#c0c0c8', metalness: 0.6, roughness: 0.4 });
/** Bronze pommel, weapon fittings */
export const BRONZE_POMMEL_MAT = new MeshStandardMaterial({ color: '#7a5a30', metalness: 0.4, roughness: 0.5 });
...
export const NEAR_BLACK_MAT = new MeshStandardMaterial({ color: '#1a1a1a', roughness: 0.8 });
/** Deep crimson: capes, horns, trim */
export const CRIMSON_MAT = new MeshStandardMaterial({ color: '#9c2c2c', roughness: 0.85 });
/** Dark plate armor */
export const DARK_ARMOR_MAT = new MeshStandardMaterial({ color: '#1f2025', metalness: 0.12, roughness: 0.7 });
...
export const FANG_MAT = new MeshStandardMaterial({ color: '#e8e6df', roughness: 0.7 });
...
export const BEAR_CLAW_MAT = new MeshStandardMaterial({ color: '#dad6c8', roughness: 0.8 });
...
export const HEALER_BELT_MAT = new MeshStandardMaterial({ color: '#d0a838', metalness: 0.2, roughness: 0.6 });
...
export const AZIR_BEAK_MAT = new MeshStandardMaterial({ color: '#e8b048', roughness: 0.7 });
...
export const WARMAIDEN_KNEE_PLATE_MAT = new MeshStandardMaterial({ color: '#a8884c', metalness: 0.35, roughness: 0.55 });
...
export const WARMAIDEN_SIGIL_MAT = new MeshStandardMaterial({ color: '#a85a28', metalness: 0.3, roughness: 0.7 });
...
export const SHADOWMAIDEN_GOLD_MAT = new MeshStandardMaterial({ color: '#c0a050', metalness: 0.45, roughness: 0.45 });
export const SHADOWMAIDEN_EMBROIDERY_MAT = new MeshStandardMaterial({ color: '#8a3a28', roughness: 0.9 });
export const SHADOWMAIDEN_SCALE_MAT = new MeshStandardMaterial({ color: '#4a5a3a', metalness: 0.25, roughness: 0.65 });
...
export const SHADOWMAIDEN_FULLER_MAT = new MeshStandardMaterial({ color: '#8a8a92', roughness: 0.7 });
...
export const PLAYER_BLADE_MAT = new MeshStandardMaterial({ color: '#c0c0c8', roughness: 0.7 });
export const PLAYER_CROSSGUARD_MAT = new MeshStandardMaterial({ color: '#a8a8b0', roughness: 0.7 });
