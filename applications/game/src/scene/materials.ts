...
export const HITBOX_MAT = new MeshStandardMaterial({
  transparent: true,
  opacity: 0,
  depthWrite: false,
});
...
export const GOLD_TRIM_MAT = new MeshStandardMaterial({
  color: '#d4a23a',
  metalness: 0.65,
  roughness: 0.28,
});
/** Steel sword/broadsword blades */
export const STEEL_BLADE_MAT = new MeshStandardMaterial({
  color: '#d4d4dc',
  metalness: 0.8,
  roughness: 0.18,
});
/** Arrow-tip steel */
export const ARROW_HEAD_MAT = new MeshStandardMaterial({
  color: '#c0c0c8',
  metalness: 0.7,
  roughness: 0.28,
});
/** Bronze pommel, weapon fittings */
export const BRONZE_POMMEL_MAT = new MeshStandardMaterial({
  color: '#7a5a30',
  metalness: 0.6,
  roughness: 0.32,
});
...
/** Dark plate armor */
export const DARK_ARMOR_MAT = new MeshStandardMaterial({
  color: '#1f2025',
  metalness: 0.4,
  roughness: 0.42,
});
...
export const WOLF_EYE_MAT = new MeshStandardMaterial({
  color: '#f4d33a',
  emissive: '#f4d33a',
...
// ── Spider ────────────────────────────────────────────────────────────────
export const SPIDER_BODY_MAT = new MeshStandardMaterial({
  color: '#15090f',
  roughness: 0.7,
  metalness: 0.05,
});
export const SPIDER_LEG_MAT = new MeshStandardMaterial({ color: '#0a0408', roughness: 0.6 });
export const SPIDER_EYE_MAT = new MeshStandardMaterial({
  color: '#ff2020',
  emissive: '#a01010',
...
export const HEALER_BELT_MAT = new MeshStandardMaterial({
  color: '#d0a838',
  metalness: 0.45,
  roughness: 0.38,
});
export const HEALER_ORB_MAT = new MeshStandardMaterial({
  color: '#a3d8ff',
  emissive: '#a3d8ff',
...
export const AZIR_STAFF_ORB_MAT = new MeshStandardMaterial({
  color: '#e8b048',
  emissive: '#e8b048',
...
export const BOWMAIDEN_LEATHER_MAT = new MeshStandardMaterial({
  color: '#a86a48',
  roughness: 0.88,
});
export const BOWMAIDEN_SASH_MAT = new MeshStandardMaterial({ color: '#2a1a40', roughness: 0.9 });
export const BOWMAIDEN_BANDAGE_MAT = new MeshStandardMaterial({
  color: '#dccab0',
  roughness: 0.88,
});
...
export const BOWMAIDEN_BOWSTRING_MAT = new MeshStandardMaterial({
  color: '#ddd5b5',
  roughness: 0.88,
});
...
export const WARMAIDEN_KNEE_PLATE_MAT = new MeshStandardMaterial({
  color: '#a8884c',
  metalness: 0.45,
  roughness: 0.38,
});
export const WARMAIDEN_KNEE_PLATE_DARK_MAT = new MeshStandardMaterial({
  color: '#6a522c',
  roughness: 0.8,
});
export const WARMAIDEN_PANTS_MAT = new MeshStandardMaterial({ color: '#b89a72', roughness: 0.9 });
export const WARMAIDEN_PANTS_TRIM_MAT = new MeshStandardMaterial({
  color: '#7a5a36',
  roughness: 0.9,
});
export const WARMAIDEN_BANDEAU_MAT = new MeshStandardMaterial({
  color: '#7a4a2a',
  roughness: 0.88,
});
export const WARMAIDEN_BANDEAU_TRIM_MAT = new MeshStandardMaterial({
  color: '#3a1f10',
  roughness: 0.9,
});
export const WARMAIDEN_SIGIL_MAT = new MeshStandardMaterial({
  color: '#a85a28',
  metalness: 0.4,
  roughness: 0.5,
});
...
// ── Shadowmaiden ─────────────────────────────────────────────────────────
export const SHADOWMAIDEN_BOOT_MAT = new MeshStandardMaterial({
  color: '#8a6438',
  roughness: 0.88,
});
export const SHADOWMAIDEN_WRAPS_MAT = new MeshStandardMaterial({
  color: '#4a3018',
  roughness: 0.9,
});
export const SHADOWMAIDEN_LINEN_MAT = new MeshStandardMaterial({
  color: '#e0d4b0',
  roughness: 0.9,
});
export const SHADOWMAIDEN_SASH_MAT = new MeshStandardMaterial({
  color: '#9a2828',
  roughness: 0.88,
});
export const SHADOWMAIDEN_GOLD_MAT = new MeshStandardMaterial({
  color: '#c0a050',
  metalness: 0.6,
  roughness: 0.3,
});
export const SHADOWMAIDEN_EMBROIDERY_MAT = new MeshStandardMaterial({
  color: '#8a3a28',
  roughness: 0.9,
});
export const SHADOWMAIDEN_SCALE_MAT = new MeshStandardMaterial({
  color: '#4a5a3a',
  metalness: 0.35,
  roughness: 0.45,
});
export const SHADOWMAIDEN_SCALE_DARK_MAT = new MeshStandardMaterial({
  color: '#2a3624',
  roughness: 0.9,
});
export const SHADOWMAIDEN_CIRCLET_DARK_MAT = new MeshStandardMaterial({
  color: '#7a6428',
  roughness: 0.7,
});
export const SHADOWMAIDEN_FEATHER_MAT = new MeshStandardMaterial({
  color: '#f4e8c4',
  roughness: 0.9,
});
export const SHADOWMAIDEN_FULLER_MAT = new MeshStandardMaterial({
  color: '#8a8a92',
  metalness: 0.65,
  roughness: 0.28,
});
...
export const SPELLMAIDEN_ROBE_INNER_MAT = new MeshStandardMaterial({
  color: '#1a0a30',
  roughness: 0.9,
});
export const SPELLMAIDEN_ROBE_DARK_MAT = new MeshStandardMaterial({
  color: '#1f0e36',
  roughness: 0.9,
});
...
export const SPELLMAIDEN_GEM_MAT = new MeshStandardMaterial({
  color: '#b04ad8',
  emissive: '#b04ad8',
  emissiveIntensity: 0.9,
});
export const SPELLMAIDEN_CRYSTAL_MAT = new MeshStandardMaterial({
  color: '#c050ff',
  emissive: '#e090ff',
  emissiveIntensity: 1.6,
});
export const SPELLMAIDEN_CRYSTAL_HALO_MAT = new MeshStandardMaterial({
  color: '#e090ff',
  emissive: '#e090ff',
...
// ── Projectiles ───────────────────────────────────────────────────────────
export const SPELL_PROJ_CORE_MAT = new MeshStandardMaterial({
  color: '#c050ff',
  emissive: '#e090ff',
  emissiveIntensity: 2.2,
});
export const SPELL_PROJ_HALO_MAT = new MeshStandardMaterial({
  color: '#e090ff',
  emissive: '#e090ff',
...
export const SWAIN_ORB_MAT = new MeshStandardMaterial({
  color: '#ff3a3a',
  emissive: '#c41a1a',
  emissiveIntensity: 1.8,
});
...
export const PLAYER_BLADE_MAT = new MeshStandardMaterial({
  color: '#c0c0c8',
  metalness: 0.75,
  roughness: 0.22,
});
export const PLAYER_CROSSGUARD_MAT = new MeshStandardMaterial({
  color: '#a8a8b0',
  metalness: 0.6,
  roughness: 0.32,
});
